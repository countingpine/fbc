...
sub cvConstTest cdecl ()
	...
	CU_ASSERT_EQUAL( d, val("1.5839800103804824e+40") )
...
sub cvNumTest cdecl ()
	...
	dim as longint s  = cvs( &H44434241 )
	dim as longint i  = cvi( 781.03521! )
	dim as longint l  = cvl( 781.03521! )
	dim as longint d  = cvd( &H4847464544434241 )
	dim as longint ll = cvlongint( val("1.5839800103804824e+40") )
